...
这次算是比较深入的了解了信号量及其可视化分析，不仅可以让我加强对 Go 的理解，还可以用进度图来达到某种程度的*形式化验证*。之前我在分析并发问题时总是会陷入思考，而并发线程越多，大脑的思考的线程就越多，这经常会导致我大脑“线程不足”，但是进度图的出现拯救了我，它提供的清晰度可以让我改掉不爱用草纸的坏习惯。以后如果再遇到合适的并发问题，不妨试试进度图吧☕️。
